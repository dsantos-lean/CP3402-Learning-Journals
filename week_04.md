...
This week, I started to look for plugins and incorporated them into my assignment website.
 
#### Resources
[Mapping the Modern Web Design Process](https://www.linkedin.com/learning/mapping-the-modern-web-design-process) - one of the linkedin videos for this week.
...
## Content Insights
- Learned a different perspective on designing and developing websites, that we(developers) are building informational user experiences for the end user. And the there is a clear separation on what matters to the site owner (ability to communicate information) and end user (ability to find and understand information).
